...
type CalculateRequest struct {
	...
	Num1          float64                `protobuf:"fixed64,1,opt,name=num1,proto3" json:"num1,omitempty"`                                    // 第一个操作数
	Num2          float64                `protobuf:"fixed64,2,opt,name=num2,proto3" json:"num2,omitempty"`                                    // 第二个操作数
	Operation     Operation              `protobuf:"varint,3,opt,name=operation,proto3,enum=calculator.Operation" json:"operation,omitempty"` // 执行的操作
...
func (x *CalculateRequest) GetNum1() float64 {
	if x != nil {
		return x.Num1
	}
	return 0
...
func (x *CalculateRequest) GetNum2() float64 {
	if x != nil {
		return x.Num2
	}
	return 0
...
type CalculateResponse struct {
	...
	Error         string                 `protobuf:"bytes,2,opt,name=error,proto3" json:"error,omitempty"`     // 错误信息，如果有的话
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_proto_calculator_proto_rawDesc = "" +
	...
	"\x04num2\x18\x02 \x01(\x01R\x04num2\x123\n" +
	"\toperation\x18\x03 \x01(\x0e2\x15.calculator.OperationR\toperation\"A\n" +
	...
	"\tCalculate\x12\x1c.calculator.CalculateRequest\x1a\x1d.calculator.CalculateResponseB\x1dZ\x1bgithub.com/calculator/protob\x06proto3"
